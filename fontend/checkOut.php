                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <?php 
                             ...
                             <td> <h5 class="btnma" data-id="<?php echo $maSP; ?>"><?php echo $item['tenSP'] ?></h5></td>
...
<?php if($_SESSION['cart']==null) {  ?>
    ...
    <h2 style="color:red" id="checkdon1"> <?php echo 'Chưa có thông tin';?></h2>
    <?php } ?>
                <hr>
    ...
    $('#errorphone').text("SDT không đúng định dạng");
                            ...
                            if (ktra=== text) {
                                ...
                                $.ajax({
                                    url: "xuLyDatHang.php",
                                    type: "POST",
                                    data: { tenKH: tenKH, diaChi: diaChi, tienTra: tien, SDT: sdt},
