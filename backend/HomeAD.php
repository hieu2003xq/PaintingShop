...
<body>
                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">QL Sản Phẩm</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="content">
        ...
        <div class="row fx-element-overlay" id="showSP1">
            <?php if ($query){
                        ...
                        <div class="box box-default">
                            <div class="fx-card-item">
                                <div class="fx-card-avatar fx-overlay-1">
                                    <img src="img/<?php echo $row['hinhAnh']; ?>" alt="Tranh">
                                    <div class="fx-overlay scrl-up">
                                        <ul class="fx-info">
                                            <li><a class="btn btn-outline btnedit" data-id="<?php echo $row['maSP']; ?>" data-toggle="modal"><i class="mdi mdi-table-edit"></i></a></li>
                                            <li><a class="btn btn-outline btndelete" href="#" data-id="<?php echo $row['maSP']; ?>" data-toggle="modal"><i class="mdi mdi-delete"></i></a></li>
                                            <li><a class="btn btn-outline btndetail"  href="detail.php?id=<?php echo $row['maSP']; ?>" ><i class="mdi mdi-settings"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="fx-card-content text-left mb-0">
                                    <div class="product-text">
                                        <h3 class="pro-price text-blue gia"><?php echo $row['giaBan']; ?><span>VND</span></h3>
                                        <h4 class="box-title mb-0"><?php echo $row['tenSP']; ?></h4>
...
$('.btnedit').on('click',function(e){
    ...
    var giaBan = $(this).closest('.fx-card-item').find('.pro-price').text().trim();
    var pargiaBan = giaBan.substring(0, giaBan.length - 3);
        // Lấy giá trị của tên sản phẩm (tenSP) từ phần tử cha chứa tên sản phẩm
     var tenSP = $(this).closest('.fx-card-item').find('.box-title').text().trim();
        var fullSrc = $(this).closest('.fx-card-item').find('img').attr('src');
        // Tách phần 'img/' để chỉ lấy phần tên ảnh
        var hinhAnh = fullSrc.split('/').pop().trim(); 
    $('#maSP').val(maSP1);
    $('#tenSP').val(tenSP);
    $('#giaBan').val(pargiaBan);
    $('#reviewAnh').attr('src', 'img/' + hinhAnh);
    //$('#tenAnh').text(hinhAnh);
    $('#add1').modal('show');
})
