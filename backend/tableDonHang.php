                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">QL đơn hàng (Table)</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        "columns": [
            ...
            { "data": "maDon" ,
                "render": function(data, type, row, meta){
                    return "<a href='chiTietDon.php?maDon="+row.maDon+"'>"+row.maDon+"</a>"
                }
            },
            { "data": "hinhAnh",
                        "render": function (data, type, row, meta) {
...
$('body').on('click','.donDangGiao',function(){
    window.location.href="donDangGiao.php";
})
$('body').on('click','.donDaGiao',function(){
    window.location.href="donDaGiao.php";
})
